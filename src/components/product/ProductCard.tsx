              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-700 text-sm italic">
                    "Just bought this makeup organizer, it's great in terms of finishing, quality, number of drawers and a must have one."
                  </p>
                  <p className="text-xs text-gray-500 mt-1">- Jamila ⭐⭐⭐⭐⭐</p>
                </div>
              </div>
            </div>
          </div>
